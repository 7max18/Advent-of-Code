...
#Solution is super elegant, but inspired by subreddit post.
...
class Monkey:
    ...
    def InspectAndThrow(self, monkeyArr, c):
...
for monkey in monkeys:
    cycleLen *= monkey.test

for roundNum in range(0, 10000):
    for monkey in monkeys:
        monkey.InspectAndThrow(monkeys, cycleLen)
